      ...
      <div className="flex flex-col gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-yellow-800 mt-1 text-center">
            ...
            & {!unpaid ? <span className='text-(--accent-secondary) font-bold'>& claim 50% on your next upload this month.</span>: <span className="text-(--accent-secondary) font-bold">& claim your 67% discount.</span>}
          </p>
