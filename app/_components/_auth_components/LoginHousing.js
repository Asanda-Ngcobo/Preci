...
function LoginHousing() {
  ...
  return (
    ...
    text-xl font-sans font-bold text-(--accent-primary)">Lease Agreement</h2>
        <h3 className="text-(--text-secondary) md:text-xs text-[12px]">
          Upload the lease and get a clear, precise summary of what you committing or have committed to.
        </h3>
      </div>
