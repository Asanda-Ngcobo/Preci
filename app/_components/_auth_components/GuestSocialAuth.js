...
function GuestSocialAuth({summaryId, token}) {
...
setIsLoading(true)
 ...
 const { error } = await supabase.auth.signInWithOAuth({
  provider: "google",
  options: {
    redirectTo: `${window.location.origin}/auth/oauth?next=/users/${summaryId}&summaryId=${summaryId}&token=${token}`,
  },
})
...
export default GuestSocialAuth
