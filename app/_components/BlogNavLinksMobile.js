...
const navLinks = [
  { name: 'All',     href: '/blog',         exact: true  },
   { name: 'Insurance',     href: '/blog/insurance', exact: false },
  { name: 'Car',     href: '/blog/car',     exact: false },
  { name: 'Housing', href: '/blog/housing', exact: false },
  { name: 'Phone & wiFi',   href: '/blog/phone',   exact: false },
...
export default function BlogNavLinksMobile() {
  ...
  return (
    <div>
      <nav className="w-full flex overflow-x-auto no-scrollbar m-2 items-center justify-center font-(--font-sans) lg:hidden">
